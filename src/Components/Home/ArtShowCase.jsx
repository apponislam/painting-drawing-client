const ArtShowCase = () => {
    return (
        <div className="container md:mx-auto">
            <h1 className="text-2xl md:text-4xl text-center my-12 uppercase font-extrabold">Top Art Showcase</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 my-20">
                <div>
